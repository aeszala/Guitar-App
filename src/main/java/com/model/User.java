 ...
 */
  ...
  * It includes properties such as id, username, password, email, name, and various collections
  * representing songs and lessons the user has interacted with (favorite songs, completed songs, etc.).
  */
 public class User {
     private UUID id;
      ...
      * 
      * @return A JSON representation of the user with attributes like id, username, password, etc.
      */
